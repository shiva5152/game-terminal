...
const page = () => {
  return (
    <div className='p-6'>
      <div>
      <div className="flex overflow-hidden relative flex-col items-start pt-16 pr-20 mt-8 w-full min-h-[453px] max-md:pr-5 max-md:max-w-full">
      <img
        loading="lazy"
      ...
      <div className="flex relative gap-3 mt-14 max-md:mt-10">
        <img
          loading="lazy"
