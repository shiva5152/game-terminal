...
const page = () => {
  return (
    ...
    <div className="mt-10 p-4 *:text-xl font-bold text-white max-md:max-w-full">
      About Game
    </div>


    <div className="mt-2 max-md:max-w-full p-4">
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        <div className="flex flex-col w-[68%] max-md:ml-0 max-md:w-full">
          <div className="text-base leading-7 text-zinc-600 max-md:mt-10 max-md:max-w-full">
            ...
            secrets, and help Cobra find the missing piece of his past...
          </div>
        </div>
    ...
    <div className="mt-20 p-4 text-5xl font-bold text-white max-md:mt-10 max-md:max-w-full">
      What other says
    </div>
