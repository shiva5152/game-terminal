...
const page = () => {
  ...
  return (
    <div className="pl-20 bg-neutral-900 max-md:pl-5">
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        <div className="flex flex-col w-[43%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col mt-36 max-md:mt-10 max-md:max-w-full">
            ...
            />
            <div className="flex gap-5 justify-between px-4 py-7 mt-20 text-base rounded-xl border border-solid border-zinc-800 text-zinc-600 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
            ...
            <div className="flex gap-5 justify-between px-4 py-7 mt-5 text-base rounded-xl border border-solid border-zinc-800 text-zinc-600 max-md:flex-wrap max-md:max-w-full">
            ...
            <div className="flex gap-5 justify-between mt-10 font-bold text-center max-md:flex-wrap max-md:max-w-full">
              <div className="overflow-hidden relative flex-col justify-center items-center px-16 py-6 text-base leading-5 whitespace-nowrap aspect-[3] fill-lime-400 text-neutral-900 w-[189px] max-md:px-5">
                ...
                />
               <button onClick={handleLogin} className="absolute">Login</button> Login
              </div>
              <div className="flex-auto my-auto text-sm leading-5 text-lime-400">
                <span className=" text-zinc-600">Don’t have any account?</span>{" "}
                <a href=""><button className="cursor-pointer hover hover:text-lime-300 hover:text-bold">Sign up</button></a>
              </div>
            </div>
            {/* <img
              loading="lazy"
            ...
            <div className="flex gap-5 self-center mt-6">
              <button onClick={handleGoogle} className="cursor-pointer border hover:border-lime-400 hover:bg-lime-300">
              <img
                loading="lazy"
              ...
              <button  onClick={handleFacebook} className="cursor-pointer border hover:border-lime-400 hover:bg-lime-300">
              <img
                loading="lazy"
        ...
        <div className="flex flex-col ml-5 w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow justify-center w-full bg-neutral-900 max-md:mt-10 max-md:max-w-full">
            <img
              loading="lazy"
              ...
              className="w-full aspect-[0.68] max-md:max-w-full"
            />
          </div>
        </div>
      </div>
