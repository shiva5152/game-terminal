...
const header = () => {
  return (
    <div>
       <div className="sm:flex hidden gap-5 mt-24 font-bold text-white max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
        <div className="sm:flex-auto flex-row justify-between text-xl sm:text-5xl ">
          <span className="text-lime-400">Trending</span> Games
        </div>
