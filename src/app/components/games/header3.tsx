  ...
  return (
    <div>
      <div className="sm:flex hidden gap-5 mt-24 font-bold text-lime-400 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
        <div className="flex-auto my-auto text-5xl max-md:text-4xl">
          Beta Lunch <span className="text-white">Games</span>
        </div>
      ...
      <div className="flex-auto text-xl">
        <span className="text-lime-400">Beta Lunch</span> Games
      </div>
