...
const Integration = () => {
  return (
    <div className="flex flex-col items-center">
      ...
      <div className={cn(sectionSubHeading, "max-w-[70%]")}>
                ...
                <div className="grow max-md:mt-2 max-md:max-w-full">
                  <div className="flex gap-5 max-md:flex-row max-md:gap-3 max-md:">
                    <div className="flex flex-col w-[18%] max-md:ml-0 max-md:w-fit">
                      <div className="flex justify-center w-[50px] h-[50px] items-center px-7 mx-auto integration-border bg-neutral-900 md:h-[102px] md:w-[102px] max-md:px-3 max-md:mt-5">
                        <img
                          loading="lazy"
