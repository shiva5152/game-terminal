...
const Achievement = () => {
  return (
    <>
      ...
      <div className="flex gap-4 justify-between self-stretch px-px mt-10 max-md:flex-wrap max-md:max-w-full">
