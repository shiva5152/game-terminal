  ...
  return (
    <>
      <div className="px-3 md:px-9  w-full max-w-[90rem] mx-auto self-stretch mt-10 md:mt-40 max-md:mt-10 max-md:max-w-full">
        <div className="flex gap-8 md:container mx-auto place-content-center max-md:flex-wrap  max-md:flex-row ">
          {cardData.map((card) => (
            <div
              key={card.id}
              // whileHover={{ scale: 1.04 }}
              // transition={{ type: "spring", stiffness: 200 }}
              className="flex  flex-col w-[31%] justify-between max-md:ml-0 max-md:aspect-square max-md:w-[45%]"
            >
              <div className="flex neomorphic-eco achievement-border rounded-xl overflow-hidden  relative flex-col grow justify-center items-center px-0 py-4 md:py-11 whitespace-nowrap h-auto md:min-h-[143px] stroke-[1px] stroke-lime-400 max-md:px-5 max-md:mt-0 max-md:max-w-full">
                ...
                /> */}
                <div className="relative h-auto w-44 max-md:w-auto flex-col flex items-center justify-center text-white font-bold text-4xl">
                  <div className="relative self-center text-center w-full text-3xl md:text-4xl font-extrabold leading-7 text-lime-400">
                    {card.text}
                  </div>
                  <div className="relative mt-2 md:mt-6 max-md:text-wrap text-xs md:text-base font-light tracking-wider md:font-medium text-center text-white">
                    {card.description}
                  </div>
                </div>
              </div>
...
export const achievementData = [
  {
    id: 1,
    className: "w-auto h-[30px] max-md:h-[16px]",
    srcSet:
...
//   {
//     id: 1,
//     srcSet: "/images/logos/Chain.png",
//     className: "w-20",
//   },
//   {
//     id: 2,
//     srcSet: "/images/logos/Cronos.png",
//     className: "w-20",
//   },
//   {
//     id: 3,
//     srcSet: "/images/logos/Meter.png",
//     className: "w-20",
//   },
//   {
//     id: 4,
//     srcSet: "/images/logos/Polygon.png",
//     className: "w-20",
//   },
//   {
//     id: 5,
//     srcSet: "/images/logos/Shardeum.png",
//     className: "w-20",
//   },
//   {
//     id: 6,
//     srcSet: "/images/logos/telos.webp",
//     className: "w-20",
//   },
// ];
const cardData = [
