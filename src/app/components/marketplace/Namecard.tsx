...
const Namecard: React.FC<NamecardProps> = ({
  ...
  return (
    <div className="flex relative flex-col sm:px-4 px-2 mt-5 w-full">
      <img loading="lazy" src={imageUrl} className="w-[100%]" />
      <div className="flex p-4">
        <div className="grow sm:text-2xl text-sm font-bold leading-7 text-white">
          {name}
        </div>
        <div className="flex-auto text-[6px] sm:text-base leading-7 text-zinc-600">
          ( {category} )
        </div>
      </div>
      ...
      <div className="flex gap-1.5 ml-2 sm:gap-1.5 w-[40%] sm:w-full sm:mt-4 sm:ml-4">
        <div className="justify-center flex px-2 gap-2">
          ...
          />
          <div className="relative sm:justify-center justify-start text-xs sm:text-sm text-white flex">
            Hot
          </div>
        </div>
        <div className="justify-center item-center ml-7  flex px-2">
          ...
          />
          <div className="flex relative justify-center text-xs sm:text-sm text-white item-center ">
            Hindi
          </div>
        </div>
        <div className="justify-center ml-7 sm:flex hidden px-2 ">
          ...
          />
          <div className="sm:flex hidden relative justify-center text-sm text-white ">
            Hot
          </div>
        </div>
        <div className="justify-center ml-7 sm:flex hidden px-2">
      ...
      <div className="flex gap-2 mt-4 sm:text-xs text-xs sm:flex-wrap font-semibold leading-5 text-white whitespace-nowrap">
        ...
        <div
          className="flex overflow-hidden relative justify-center flex-col flex-1 gap-1 px-4 aspect-[] fill-zinc-800"
          style={{
            backgroundImage: `url('/srect.png')`,
      ...
      <div className="flex gap-5 justify-between mt-4">
        <div className="text-base leading-5 text-right text-white">
          <span className="font-semibold text-white text-xl sm:text-3xl">
            $
          </span>
      ...
      <Link
        ...
        className=" flex flex-col justify-center text-center p-4 text-neutral-900 max-md:px-5"
        style={{
          backgroundImage: `url('/g8.png')`,
          backgroundRepeat: "no-repeat",
          backgroundPosition: "center",
          backgroundSize: "100%",
        }}
