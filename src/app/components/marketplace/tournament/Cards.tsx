      ...
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow items-start py-8 pr-20 pl-8 w-full font-bold rounded-3xl border border-lime-400 border-solid bg-neutral-900 max-md:px-5 max-md:mt-10 max-md:max-w-full">
            ...
            <div className="overflow-hidden relative flex-col justify-center px-14 py-5 mt-8 text-base leading-5 text-center aspect-[3.58] fill-lime-400 text-neutral-900 max-md:px-5">
              <img
                loading="lazy"
              ...
              />
              <div className='absolute mb-8'>Buy a <br />Node</div>
            </div>
          </div>
        </div>
        <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow py-8 pr-4 pl-8 w-full rounded-3xl border border-lime-400 border-solid bg-neutral-900 max-md:pl-5 max-md:mt-10 max-md:max-w-full">
            ...
            <div className="flex gap-2.5 mt-6 text-base whitespace-nowrap max-md:flex-wrap">
              ...
              <div className="overflow-hidden relative flex-col justify-center px-12 py-5 my-auto font-bold text-center aspect-[2.64] fill-lime-400 leading-[129%] text-neutral-900 max-md:px-5">
                <img
                  loading="lazy"
                  ...
                  className="object-cover absolute inset-0 size-full"
                />
               <div className='absolute'> Copy</div> Copy
              </div>
            </div>
