const Terminal = () => {
  return (
    <div className="flex items-center mx-auto flex-col">
      ...
      <div className="mt-8 text-xl font-light leading-7 tracking-wide text-center whitespace-nowrap text-zinc-600">
        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow justify-center items-start px-7 py-6 w-full text-xs font-bold rounded-3xl bg-neutral-900 max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="self-stretch mt-4 font-light leading-4 tracking-wider text-zinc-600 max-md:max-w-full">
              ...
              <button className="overflow-hidden relative button-bg flex-col justify-center font-bold items-center px-8 py-8 mt-4 text-center text-black whitespace-nowrap aspect-[3.12] fill-lime-400 leading-[233%] max-md:px-5">
                Enroll Now
              </button>
            </div>
          </div>
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow justify-center items-start px-7 py-6 w-full text-xs font-bold rounded-3xl bg-neutral-900 max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <button className="overflow-hidden button-bg relative flex-col justify-center px-8 font-bold py-8 mt-4 text-center items-center text-black whitespace-nowrap aspect-[3.12] fill-lime-400 leading-[233%] max-md:px-5">
                Contact Us
              </button>
            </div>
          </div>
