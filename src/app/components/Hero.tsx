...
const Hero = () => {
  ...
  return (
    <div className="mx-auto min-h-[80vh] md:h-auto flex flex-col items-center relative mb-24">
      <div className="mt-40 text-7xl  font-bold text-center text-white max-md:mt-10 max-md:max-w-full max-md:text-5xl">
        <p>
      ...
      <div className="mt-7 text-xl font-light leading-7 tracking-wide text-center text-zinc-600 max-md:max-w-full  max-md:text-[1rem]">
      ...
      {/* <button className="overflow-hidden mx-auto button-bg  md:mx-0 relative flex-col justify-center items-center self-start px-11 py-8 mt-4 md:mt-8 text-[0.5rem] md:text-sm leading-7 text-black whitespace-nowrap aspect-[3.15] fill-lime-400 max-md:px-5 ">
        Browse Games
      </button> */}
      <Link
        href={"/#gaming"}
      ...
      >
        <div className="mt-20 text-xs font-medium text-center text-white whitespace-nowrap max-md:mt-10">
          Scroll down
        </div>
        <img
          loading="lazy"
