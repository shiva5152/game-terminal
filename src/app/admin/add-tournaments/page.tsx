    ...
    <div className="bg-gray-900 w-[80%] my-10 flex justify-center items-center flex-col text-white p-4">
      ...
      <form onSubmit={handleSubmit} className="w-[60%]">
        <div className="mb-4">
          ...
          <Select value={formData.map} onValueChange={handleValueChange("map")}>
        ...
        <div className="mb-4">
          ...
          >
            ...
            <SelectContent className="bg-gray-800 text-white">
              <SelectGroup>
                <SelectItem value="teamDeathMatch">Team Death Match</SelectItem>
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) => handleSetFormData("goalTarget", e.target.value)}
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) => handleSetFormData("bonusAmount", e.target.value)}
              className="w-full px-3 py-2 rounded bg-gray-800 text-white"
            />
          </div>
          <div className="mb-4">
